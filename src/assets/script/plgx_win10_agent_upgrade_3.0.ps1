...
# Use this script to perform upgrade on EclecticIQ Agent v3.0 via 
...
$xmlurl = -join("https://", $ip, "/downloads/windows/plgx_agent_upgrade_3.0.xml")
$output = -join($tempdir, "plgx_cpt_maint.exe")
$taskxml = -join($tempdir, "plgx_agent_upgrade_3.0.xml")
