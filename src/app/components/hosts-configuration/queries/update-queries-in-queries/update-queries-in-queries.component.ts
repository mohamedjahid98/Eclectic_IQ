...
@Component({
selector: 'app-update-queries-in-queries',
templateUrl: './update-queries-in-queries.component.html',
styleUrls: ['./update-queries-in-queries.component.css']
})
export class UpdateQueriesInQueriesComponent implements OnInit {
...
saveForm() {
  this.queriesdata_data_json = this.updateQuery.value;
this.submitted = true;
